 ...
 *  结合ViewPager实现懒加载
 */
abstract class BaseMultiRecycleViewFragment<T : MultiItemEntity> : BaseVmMeFragment() {
    ...
    private fun initRecycleviewLayout() {
        ...
        smartRefreshUtil = SmartRefreshMeUtil(baseAdapter, recycleview_fans, smartRefreshLayout_fans,
